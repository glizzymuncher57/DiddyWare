...
function()k()end)c.Add('onSlowUpdate',function()if h and type(h)=='table'and
next(h)then local l=utility.GetTickCount()for m,n in pairs(h)do if(l-n)>1000
then h[m]=nil end end end end)end return b end function a.s()local b,c,d,e,f={},
a.load'c',a.load'a',a.load'b',a.load'h'local g,h,i,j,k,l,m,n,o,p,q,r,s,t,u=d:
